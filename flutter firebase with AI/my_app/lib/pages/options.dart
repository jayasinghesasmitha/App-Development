...
import 'package:my_app/pages/aipredict.dart';

class OptionsPage extends StatelessWidget {
  final String email;
  const OptionsPage({super.key, required this.email});

  String get apiUrl => 'http://10.0.2.2:3000/save-selection'; // Updated for Android emulator
              ...
              _buildNatureButton(
                ...
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => const AiPredictPage(),
                    ),
                  );
                },
              ),
